...
var MessageWhere = struct {
	...
	UUID:           whereHelperstring{field: "\"messages\".\"uuid\""},
	ConversationID: whereHelpernull_String{field: "\"messages\".\"conversation_id\""},
	Role:           whereHelpernull_String{field: "\"messages\".\"role\""},
...
var (
	messageAllColumns            = []string{"uuid", "conversation_id", "role", "content", "created_at"}
	messageColumnsWithoutDefault = []string{"uuid"}
	messageColumnsWithDefault    = []string{"conversation_id", "role", "content", "created_at"}
	messagePrimaryKeyColumns     = []string{"uuid"}
...
func (o *Message) Conversation(mods ...qm.QueryMod) conversationQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"uuid\" = ?", o.ConversationID),
	}
...
func (messageL) LoadConversation(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`conversations.uuid in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ConversationID, foreign.UUID) {
...
func (o *Message) SetConversation(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Conversation) error {
	...
	queries.Assign(&o.ConversationID, related.UUID)
	if o.R == nil {
		o.R = &messageR{
...
func (o *Message) RemoveConversation(ctx context.Context, exec boil.ContextExecutor, related *Conversation) error {
	var err error
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, uUID string, selectCols ...string) (*Message, error) {
	messageObj := &Message{}
	...
	query := fmt.Sprintf(
		"select %s from \"messages\" where \"uuid\"=$1", sel,
	)
...
func (o *Message) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"messages\" WHERE \"uuid\"=$1"
...
func (o *Message) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindMessage(ctx, exec, o.UUID)
	if err != nil {
		return err
	}
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, uUID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"messages\" where \"uuid\"=$1 limit 1)"
...
func (o *Message) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return MessageExists(ctx, exec, o.UUID)
}
