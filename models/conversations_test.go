...
func testConversationsExists(t *testing.T) {
	...
	e, err := ConversationExists(ctx, tx, o.UUID)
	if err != nil {
...
func testConversationsFind(t *testing.T) {
	...
	conversationFound, err := FindConversation(ctx, tx, o.UUID)
	if err != nil {
		t.Error(err)
	}
...
func testConversationToManyMessages(t *testing.T) {
	...
	queries.Assign(&b.ConversationID, a.UUID)
	queries.Assign(&c.ConversationID, a.UUID)
...
func testConversationToManyAddOpMessages(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if !queries.Equal(a.UUID, first.ConversationID) {
			t.Error("foreign key was wrong value", a.UUID, first.ConversationID)
		}
		if !queries.Equal(a.UUID, second.ConversationID) {
			t.Error("foreign key was wrong value", a.UUID, second.ConversationID)
		}
...
func testConversationToManySetOpMessages(t *testing.T) {
	var err error
	...
	if !queries.Equal(a.UUID, d.ConversationID) {
		t.Error("foreign key was wrong value", a.UUID, d.ConversationID)
	}
	if !queries.Equal(a.UUID, e.ConversationID) {
		t.Error("foreign key was wrong value", a.UUID, e.ConversationID)
	}
...
func testConversationToManyRemoveOpMessages(t *testing.T) {
	var err error
...
var (
	conversationDBTypes = map[string]string{`UUID`: `uuid`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_                   = bytes.MinRead
)
